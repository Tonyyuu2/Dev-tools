...
const data = [
  {
    ...
    description:
      "About A large dataset of 4.2m Java source code and parallel data of their description from code search, and code summarization studies.",
  ...
  },
  {
    ...
    description:
      "A fun day with new developers. Introduction to company value and culture. Also saw them the tech stack that we use.",
...
const journaEntryList = data.map((entry, index) => (
  <JournalItem key={index} {...entry} data={data} />
));
